...
> If you want to know more about `Select Case` statment then please visit [If-Then and Select Case structure](/visual-basic/vba-if-then-structure-select-case) post.
...
If you want to read more about **Select Case** then please visit [If-Then and Select Case structure](/visual-basic/vba-if-then-structure-select-case).
