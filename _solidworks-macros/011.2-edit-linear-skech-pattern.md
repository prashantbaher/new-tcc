...
This post is extension of previous **[Solidworks Macro - Linear Sketch Pattern](/solidworks-macro/linear-skech-pattern)** post.

I recommend you to read **[Solidworks Macro - Linear Sketch Pattern](/solidworks-macro/linear-skech-pattern)** post because we are using same code sample.
...
## For Experience Macro Developer - Edit Linear Sketch Pattern
...
## For Beginners Macro Developers - Edit Linear Sketch Pattern
...
Since this post is *an extension* of previous **[Solidworks Macro - Linear Sketch Pattern](/solidworks-macro/linear-skech-pattern)** post, then I will start explaining from **Last line** only.

If you want to understand every line of code, then please visit **[Solidworks Macro - Linear Sketch Pattern](/solidworks-macro/linear-skech-pattern)** post "first", then read this post.
...
In my previous **[Solidworks Macro - Linear Sketch Pattern](/solidworks-macro/linear-skech-pattern)** post, we created a Linear pattern *3 instances* in *x-direction*.
