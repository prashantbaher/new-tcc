...
To do this, we first need to create a new empty macro. If you don't know how to create an empty macro; then please go to this [post](/solidworks-macro/open-new-document).
