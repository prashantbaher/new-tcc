...
This post is similar to previous **[Solidworks Macro - Edit Circular Sketch Pattern](/solidworks-macro/edit-circular-skech-pattern)** post.

If you have not visited my previous **[Solidworks Macro - Edit Circular Sketch Pattern](/solidworks-macro/edit-circular-skech-pattern)** post, then please do check-it if you want to learn Editing Circular Sketch Patterns.
...
For more information about `CreateCircleByRadius` method, you can read my [Solidworks Macro - Create Circle By Radius](/solidworks-macro/create-circle-by-radius) post.
